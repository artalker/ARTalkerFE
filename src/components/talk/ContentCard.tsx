...
const ContentCard = ({
  ...
  return (
    <div
      ...
      } absolute top-0 left-1/2 transform -translate-x-1/2 w-[374px] flex flex-col justify-start items-start border-[1px] border-[transparent] border-b-[#E5E5E5] bg-[#FFFFFF] mb-[6px] overflow-hidden`}
    >
      {isExpanded ? (
        ...
        <div className='w-full h-full relative'>
          <div className='w-full h-full p-[6px] flex justify-center items-start gap-[12px]'>
            <img
              src={content.img}
              alt={content.title}
